...
# Fix for late udev events causing throw back to the login screen
Patch10001: 0001-local-display-factory-Fix-type-of-signal-connection-.patch
Patch10002: 0002-local-display-factory-Stop-listening-to-udev-events-.patch
...
%changelog
* Wed Apr 13 2022 Ray Strode <rstrode@redhat.com> - 1:42.0-2
- Fix spurious switches back to the login screen on udev events
  Resolves: #2071394
